<template>
  <div <div fxFlex="value%" fxFlexAlign="start">
    ...
    <div class="d-flex justify-content- mt-5">
      ...
      <b-card
        ...
        img-top
        tag="article"
        style="background-color: cornflowerblue; max-width: 30rem"
        class="mb-2"
      >
        <b-card-text>
        ...
        <b-button to="/" pill variant="primary">Home</b-button>
        <b-button @click="deleteCard" pill variant="danger">Delete</b-button>
        <b-button @click="editCard" pill variant="secondary">Edit</b-button>
      </b-card>
    </div>
  </div>
</template>
